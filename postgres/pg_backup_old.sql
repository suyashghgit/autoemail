...
DROP SEQUENCE IF EXISTS public.email_metrics_id_seq;
DROP SEQUENCE IF EXISTS public.mailing_list_user_id_seq;
DROP SEQUENCE IF EXISTS public.oauth_credentials_id_seq;
DROP SEQUENCE IF EXISTS public.sequence_update_history_id_seq;
